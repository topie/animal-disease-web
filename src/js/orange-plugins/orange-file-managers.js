...
(function ($, window, document, undefined) {
            ...
            var formOpts = {
                ...
                buttons: [{
                    ...
                    handle: function () {
                        $.ajaxFileUpload(
                            {
                                url: that.manager.options.url.upload + "?animal_disease_token=" + App.token + "&folderPath=" + that.currentPath,
                                type: "POST",
                                secureuri: false,
    ...
    File.prototype = {
        ...
        download: function () {
            ...
            var that = this;
            window.open(that.folder.manager.options.url.download + "?animal_disease_token=" + App.token + "&folderPath=" + folderPath + "&fileName=" + fileName);
        },
        unCompress: function () {
            var that = this;
