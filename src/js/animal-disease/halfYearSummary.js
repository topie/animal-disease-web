...
(function ($, window, document, undefined) {
    var mapping = {
        "/api/animal/report/halfYear/summary": "halfYearSummary"
    };
    ...
    App.halfYearSummary = {
        page: function (title) {
            App.content.empty()
            App.title(title)
            var content = $('<div class="panel-body" id="halfYear_summary_grid"></div>')
    ...
    var initEvents = function () {
        var grid = {}
        var options = {
            url: App.href + "/api/animal/report/halfYear/summary",
        ...
        grid = window.App.content.find("#halfYear_summary_grid").orangeGrid(options)
    }
