...
(function ($, window, document, undefined) {
    var mapping = {
        "/api/animal/report/week/history": "weekHistory"
    };
    ...
    App.weekHistory = {
        page: function (title) {
            App.content.empty()
            App.title(title)
            var content = $('<div class="panel-body" id="week_history_grid"></div>')
    ...
    var initEvents = function () {
        var grid = {}
        var options = {
            url: App.href + "/api/animal/report/week/history",
        ...
        grid = window.App.content.find("#week_history_grid").orangeGrid(options)
    }
