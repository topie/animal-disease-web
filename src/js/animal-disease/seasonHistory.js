...
(function ($, window, document, undefined) {
    var mapping = {
        "/api/animal/report/season/history": "seasonHistory"
    };
    ...
    App.seasonHistory = {
        page: function (title) {
            App.content.empty()
            App.title(title)
            var content = $('<div class="panel-body" id="season_history_grid"></div>')
    ...
    var initEvents = function () {
        var grid = {}
        var options = {
            url: App.href + "/api/animal/report/season/history",
        ...
        grid = window.App.content.find("#season_history_grid").orangeGrid(options)
    }
